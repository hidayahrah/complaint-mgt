...
<html lang="en">
<head>
    <title>UITMCTKKT | Staff List :: UiTM</title>
    <!-- Meta Tags -->
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="liststaff.php" class="active">
 ...
 if (isset($_GET["update"])){
  ...
  <?php
            ...
            <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">Staff List</h4>
                 ...
                 while($row = mysqli_fetch_assoc($result)){
                    ...
                    echo '<td>';
                    echo '<a class="btn btn-primary error-w3l-btn mt-sm-5 mt-3 px-4" onclick="return confirm_delete()" href="delete.php?staff_id='.$row["staff_id"].'">Deactivate</a>';
                    echo '</td>';
                    echo '</tr>';
                 }
                    ?>
