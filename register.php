...
if(isset($_POST["submit"])){
    ...
    $sql = "INSERT INTO user (fname, lname, email, pword, pwordcon, phone_num, roles ) VALUES "
            ."('$fname','$lname', '$email', '$pword', '$pwordcon', '$phone_num', '$roles')";
...
<head>
    <title>UITMCTKKT | Register :: UiTM</title>
    <!-- Meta Tags -->
