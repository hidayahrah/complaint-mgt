...
if(isset($_POST["submit"])){
    ...
    $hou_phone= $_POST["hou_phone"];
    
    $sql = "INSERT INTO hou (hou_name, email, idhou, pword, pwordcon, hou_phone ) VALUES "
            ."('$hou_name', '$email', '$idhou', '$pword', '$pwordcon', '$hou_phone')";
    $result = mysqli_query($db, $sql);
    if($result){
        echo "<script> alert('REGISTRATION SUCCESSFUL!')</script>";
        // include_once ("listhou.php");
    }else {
        echo "";
    }
}
...
<head>
    <title>UITMCTKKT | Register Head of Unit :: UiTM</title>
    <!-- Meta Tags -->
            ...
            <div class="form-body-w3-agile text-center w-lg-50 w-sm-75 w-100 mx-auto mt-5">
                <form action="#" method="post">
                    <div class="form-group">
                        <label>Name</label>
                        <input type="text" id="hou_name" name="hou_name" class="form-control" placeholder="Enter your name" required="">
                    </div>
                    <div class="form-group">
                        <label>Email</label>
                    ...
                    <div class="form-group">
                        <label>Head of Unit ID</label>
                        <input type="text" id="idhou" name="idhou" class="form-control" placeholder="Enter Head of Unit ID" required="">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="hou_phone" name="hou_phone" class="form-control" placeholder="Enter phone number" required="">
                    </div>
