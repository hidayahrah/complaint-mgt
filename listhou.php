...
<html lang="en">
<head>
    <title>UITMCTKKT | Head of Unit List :: UiTM</title>
    <!-- Meta Tags -->
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="listhou.php" class="active">
 ...
 if (isset($_GET["update"])){
  ...
  <?php
            ...
            <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">Head of Unit List</h4>
                 ...
                 while($row = mysqli_fetch_assoc($result)){
                    echo '<tr>';
                    echo '<td>'.$no++.'</td>'; 
                    echo '<td>'.$row["hou_name"].'</td>';
                    echo '<td>'.$row["idhou"].'</td>';
                    echo '<td>'.$row["hou_phone"].'</td>';
                    echo '<td>'.$row["email"].'</td>';
                    echo '<td>';
                    echo '<a class="btn btn-primary error-w3l-btn mt-sm-5 mt-3 px-4" onclick="return confirm_delete()" href="delete.php?hou_id='.$row["hou_id"].'">Deactivate</a>';
                    echo '</td>';
                    echo '</tr>';
                 }
                    ?>
