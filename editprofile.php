...
$row = mysqli_fetch_assoc($result);
        ...
        //$code = $_GET["prod_id"];
	$product_array = $db_handle->runQuery("SELECT * FROM user WHERE email='$email'");
...
<head>
    <title>UITMCTKKT | My Profile :: UiTM</title>
    <!-- Meta Tags -->
                            ...
                            <div class="dropdown-menu drop-3">
                                <div class="profile d-flex mr-o">
                                    ...
                                    <div class="profile-r align-self-center">
                                        ...
                                        <a href="editprofile.php?email="><?php 
            ...
            <div class="outer-w3-agile mt-3">
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input value="<?php echo $product_array[$key]["pword"]; ?>" type="password" class="form-control" name="pword" id="pword" required="">
                        </div>
                        <div class="form-group col-md-6">
                                <label for="pwordcon">Repeat Password</label>
                                <input value="<?php echo $product_array[$key]["pwordcon"];?>" type="password" class="form-control" id="pwordcon" name="pwordcon" required="">
                            </div>
                        </div>
                        <div class="form-group">
                                ...
                                <input type="submit" value="Update Profile" name="submit" class="btn btn-primary py-3 px-5" />
                    </form>
                    <?php
